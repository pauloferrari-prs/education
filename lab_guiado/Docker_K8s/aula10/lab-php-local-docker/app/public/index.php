...
if ($path === '/') {
    ...
    <section class="hero">
      <div class="hero-box">
        ...
        <p>Lab local com Docker Compose, MySQL em container, Nginx e PHP-FPM.</p>
        <div class="meta">
          <span>Domínio local: <?= h(config('APP_URL', 'http://localhost:8080')) ?></span>
          <span>Banco em container</span>
          <span>Imagens em bind mount</span>
        </div>
      </div>
    </section>
...
if ($path === '/cadastro') {
    ...
    <section class="layout-2">
      <div class="panel">
        ...
        <p>Os dados serão gravados no MySQL em container local.</p>
      ...
      <div class="panel">
        ...
        <ul>
          <li>Conexão da aplicação com MySQL em container</li>
          <li>Configuração por variáveis de ambiente no arquivo .env</li>
          <li>Nginx fazendo proxy para PHP-FPM</li>
          <li>Imagens servidas do bind mount local</li>
        </ul>
      </div>
    </section>
    <?php
